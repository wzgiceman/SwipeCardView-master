...
import com.lorentzos.flingswipe.ProgressCircleView;
...
public class MainActivity extends AppCompatActivity implements SwipeFlingAdapterView.onFlingListener,
    ...
    public void onLeftCardExit(Object dataObject) {
        ...
        circleView.setCurrentPosition(circleView.getCurrentPosition() - 1 < 0 ? 4 : circleView.getCurrentPosition() - 1);
    }
    ...
    public void onStart() {
        ...
        Action viewAction = Action.newAction(
                ...
                Uri.parse("android-app://me.payge.swipecardview/http/host/path")
        );
